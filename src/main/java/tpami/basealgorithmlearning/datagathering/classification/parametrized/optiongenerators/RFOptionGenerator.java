...
public class RFOptionGenerator implements IExperimentKeyGenerator<String> {

	private static final List<String> BINARY_OPTIONS = Arrays.asList("-B");
	private static final List<String> I = Arrays.asList("1", "2", "4", "8", "16", "32", "64", "128"); // I: number of trees (100 is default)
	...
	public int getNumberOfValues() {
		return BINARY_OPTIONS.size() + I.size() + K.size() + M.size() + V.size() + D.size() + N.size();
	}
