...
public class ParametrizedPreprocessorConfigContainer implements IConfigContainer {
	...
	public ParametrizedPreprocessorConfigContainer(final String dbconfig, final String searcher, final String evaluator) throws Exception {
		...
		this.databaseHandle = new ExperimenterMySQLHandle(this.adapter, "evaluations_pp_" + searcher.toLowerCase() + "_" + evaluator.toLowerCase() + "_configured");
