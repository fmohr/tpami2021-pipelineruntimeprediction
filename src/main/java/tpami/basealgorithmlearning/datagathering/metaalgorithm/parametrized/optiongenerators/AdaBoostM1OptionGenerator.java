...
public class AdaBoostM1OptionGenerator implements IExperimentKeyGenerator<String> {
	...
	private static final List<List<String>> COMBOS = new ArrayList<>(SetUtil.cartesianProduct(Arrays.asList(Q, P, I)));
